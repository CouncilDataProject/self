...
1.  Attach the Google Service Account JSON as GitHub Repository Secret.
    ...
    1. Create a [new secret](https://github.com/CouncilDataProject/self/settings/secrets/actions/new)

    -   Set the name to: **GOOGLE_CREDENTIALS**
    -   Set the value to: the contents of the file `.keys/cdp-self-chjtigrp.json`
    -   Click "Add secret"

    2. Create a [new secret](https://github.com/CouncilDataProject/self/settings/secrets/actions/new)
...
1.  Initial Firebase Storage.
    ...
    [Firestore Storage Page](https://console.firebase.google.com/u/0/project/cdp-self-chjtigrp/storage)
